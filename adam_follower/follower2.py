...
class Follower():
    def __init__(self):
        ...
        self.max_linear_speed = rospy.get_param("~max_linear_speed", 3.0)
        ...
        self.depth_ultrasonic = rospy.Subscriber('ultrasonic_distance', float32, self.distance, queue_size=1)

        rospy.loginfo("Subscribing to pointcloud...")
